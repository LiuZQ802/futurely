...
export const messages = {
  ...
  en: {
    ...
    workDirsSection:        'Work Directories',
    addDirBtn:              'Add Directory',
    ...
    aboutSection:           'About',
    aboutDesc:              'Floating desktop task list — edge-snap, always on top.',
